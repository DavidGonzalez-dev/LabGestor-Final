...
$query_P = 'select fecha_fabricacion, fecha_vencimiento, descripcion_producto, activo_producto, presentacion_producto, cantidad_producto, numero_lote_producto, tamano_lote_producto, id_cliente, id_fabricante, id_modulo from productos';
