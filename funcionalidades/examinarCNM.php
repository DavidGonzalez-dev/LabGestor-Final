...
<h2>Deteccion de Microorganisms</h2>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO controles_negativos_medios ( id_control_negativo, codigo_control_negativo, fechayhora_incubacion, fechayhora_lectura, fechayhora_lectura, resultado, id_usuario, numero_registro_producto ) VALUES ('$idControlNegativo', '$codigoControlNegativo', '$fechayHoraIncubacion', '$fechayHoraLectura', '$resultado', '$idUsuario', '$numeroRegistroProducto')";
        if ($conexion->query($sql) === TRUE) {
            echo "<script>
                alert('Se ingreso el formulario de de manera exitosa.');
                location.href = '../templates/vistaCNM.php';
                </script>";
        } else {
