...
<div class="page-flex">
  ...
  <h2>Pruebas de Recuento</h2>
      <form method="POST" action="examinarRPR.php">
      ...
      if (isset($_POST['submit'])) {
          ...
          $sql = "INSERT INTO pruebas_recuento ( id_prueba_recuento, codigo_prueba_recuento, metodo_usado, concepto, especificacion, volumen_diluyente, tiempo_disolucion, cantidad_muestra, tratamiento, id_usuario, numero_registro_producto ) VALUES ('$idPruebaRecuento', '$codigoPruebaRecuento', '$metodoUsado', '$concepto', '$especificacion', '$volumenDiluyente', '$tiempodisolucion', '$cantidadMuestra', '$tratamiento', '$idUsuario', '$numeroRegistroProducto')";
          if ($conexion->query($sql) === TRUE) {
              echo "<script>
                  alert('Se ingreso el formulario de de manera exitosa.');
                  location.href = 'vistaRPR.php';
                  </script>";
          } else {
